...
namespace Odoo.Net.Core
{
    public abstract class MetaField
    {
        ...
        /// <param name="property"></param>
        protected internal void Set(object value, [CallerMemberName] string property = null)
        {
        ...
        /// <returns></returns>
        public virtual bool CanMerge(MetaField target)
        {
        ...
        /// </summary>
        /// <param name="target"></param>
        public virtual void MergeTo(MetaField target)
        {
